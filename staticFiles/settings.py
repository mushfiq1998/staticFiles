...
SECRET_KEY = 'django-insecure-hl8%7&@sq$^y+h^griol1t4h!#pj=ml5vfj9dx17#+4ac&$#^&'
...
TEMPLATES = [
    {
        ...
        # For templates folder inside project folder
        'DIRS': [TEMPLATE_DIR],
        # For templates folder inside applications
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
